	...
	<body>
		<div id="header">
			<div>
				...
				<div class="inlinecenterblock">
					<h1 style="margin: 0px; font-size: 30px; text-align: left; color: <?php echo $maincolor ?>; font-weight: bold;">
						<a href="http://localhost/toko_alat_kesehatan1/register.php">Register</a>
					</h1>
				</div>

				<div class="inlinecenterblock">
					<h1 style="margin: 0px; font-size: 30px; text-align: left; color: <?php echo $maincolor ?>; font-weight: bold;">
						<a href="http://localhost/toko_alat_kesehatan1/payment.php">Pembayaran</a>
					</h1>
				</div>

				<div class="inlinecenterblock">
					<h1 style="margin: 0px; font-size: 30px; text-align: left; color: <?php echo $maincolor ?>; font-weight: bold;">
						<a href="http://localhost/toko_alat_kesehatan1/ulasan.php">Ulasan</a>
					</h1>
				</div>

				<!-- <div class="inlinecenterblock">
					<h1 style="margin: 0px; font-size: 30px; text-align: left; color: <?php echo $maincolor ?>; font-weight: bold;">
						<a href="http://localhost/toko_alat_kesehatan1/latihan2.php">Kirim Email</a>
					</h1>
				</div> -->

				<div class="inlinecenterblock">
					<h1 style="margin: 0px; font-size: 30px; text-align: left; color: <?php echo $maincolor ?>; font-weight: bold;">
						<a href="http://localhost/toko_alat_kesehatan1/admin.php">Login Admin</a>
					</h1>
				</div>
		...
		<script>
			...
			function showcartui() {
				...
				cartdata += "<label><?php echo uilang("Delivery Method") ?></label><select id='cdmethod'><?php echo uilang("Delivery Method") ?><option>Transfer ATM</option><option>Bayar Ditempat</option></select>"
