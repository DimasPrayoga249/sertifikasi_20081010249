...
<body>
				...
				<div style="display: table-row; height: 100%;">
					<div class="adminmenubar">
						<div class="stickythingy">
							...
							<a href="<?php echo $baseurl ?>admin.php?lampiran">
								<div class="adminleftbaritem"><i class="fa fa-file-pdf-o" style="width: 30px;"></i>Lampiran</div>
							</a>
							<a href="<?php echo $baseurl ?>admin.php?payments">
								<div class="adminleftbaritem"><i class="fa fa-credit-card" style="width: 30px;"></i>Pembayaran</div>
							</a>
							<a href="<?php echo $baseurl ?>admin.php?ulasan">
								<div class="adminleftbaritem"><i class="fa fa-comment" style="width: 30px;"></i>Ulasan</div>
							</a>
					...
					<div style="display: table-cell; padding: 25px; vertical-align: top; border-left: 1px solid <?php echo $maincolor ?>; ">
						...
						?>
							<div class="postform">
								...
								<form action="postupload.php" method="post" enctype="multipart/form-data">
									...
									<!-- <label>Catatan<i class="fa fa-tag" placeholder="Catatan"></i> ?></label>
									<input type="text"> -->
						...
						?>
							...
							if ($result->num_rows > 0) {
								...
								echo "<table border='1' class='display nowrap' style='width: 100%'>";
								echo "<tr><th>ID Pembayaran</th><th>ID Order</th><th>Payment Price</th><th>Payment Date</th><th>Picture</th><th>Transfer From</th><th>Transfer To</th><th>Transfer To Account No</th></tr>";
								...
								while ($row = $result->fetch_assoc()) {
									...
									echo "<td>" . $row["transfer_to_account_no"] . "</td>";
									echo "</tr>";
								}
						...
						?>
							...
							<table class="table table-bordered">
								...
								<tbody>
									<?php
									// Sambungkan ke database (gantilah dengan koneksi sesuai dengan konfigurasi Anda)
									include("dbcon2.php");

									// Query untuk mengambil data ulasan
									$query = "SELECT user_id, order_id, rating, comment, product_image FROM reviews";
									$result = $mysqli->query($query);
									...
									if ($result->num_rows > 0) {
										...
										echo "<tr><td colspan='5'>Tidak ada ulasan yang ditemukan.</td></tr>";
									}
	...
	//not logged in
		...
		?>
			<div class="loginform">
				<h1>
					<a href="http://localhost/toko_alat_kesehatan1/">Back</a>
				</h1>
